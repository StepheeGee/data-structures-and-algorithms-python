...
class Dog:
    ...
    def __init__(self, name):
        """Initialize a Dog instance with the given name."""
        self.name = name
        self.species = "dog"
...
class Cat:
    ...
    """
    def __init__(self, name):
        """Initialize a Cat instance with the given name."""
        self.name = name
        self.species = "cat"
...
class AnimalShelter:
    ...
    """
    def __init__(self):
        """Initialize the AnimalShelter with separate queues for dogs and cats."""
